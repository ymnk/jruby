...
public class RubyBigDecimal extends RubyNumeric {
    ...
    public static RubyClass createBigDecimal(Ruby runtime) {
        ...
        result.getMetaClass().defineFastMethod("limit", callbackFactory.getFastOptSingletonMethod("limit"));
    ...
    public static IRubyObject mode(final IRubyObject recv, IRubyObject[] args) {
        ...
        final Ruby runtime = recv.getRuntime();
        final RubyClass clazz = runtime.getClass("BigDecimal");
        final RubyModule c = (RubyModule)recv;
        ...
        final long EXCEPTION_ALL = ((RubyFixnum)clazz.fastSearchConstant("EXCEPTION_ALL")).getLongValue();
        if ((longMode & EXCEPTION_ALL) != 0) {     
            ...
            RubyFixnum EXCEPTION_INFINITY = (RubyFixnum)clazz.fastSearchConstant("EXCEPTION_INFINITY");
            ...
            RubyFixnum EXCEPTION_NaN = (RubyFixnum)clazz.fastSearchConstant("EXCEPTION_NaN");
        ...
        final long ROUND_MODE = ((RubyFixnum)clazz.fastSearchConstant("ROUND_MODE")).getLongValue();
        if (longMode == ROUND_MODE) {
            ...
            if (roundingMode == clazz.fastSearchConstant("ROUND_UP") ||
                    roundingMode == clazz.fastSearchConstant("ROUND_DOWN") ||
                    roundingMode == clazz.fastSearchConstant("ROUND_FLOOR") ||
                    roundingMode == clazz.fastSearchConstant("ROUND_CEILING") ||
                    roundingMode == clazz.fastSearchConstant("ROUND_HALF_UP") ||
                    roundingMode == clazz.fastSearchConstant("ROUND_HALF_DOWN") ||
                    roundingMode == clazz.fastSearchConstant("ROUND_HALF_EVEN")) {
