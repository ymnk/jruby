...
public final class Ruby {
    ...
    public IRubyObject evalScriptlet(String script, DynamicScope scope) {
        ...
        try {
            ...
            return ASTInterpreter.__INTERPRET_ROOT__(this, context, node, context.getFrameSelf());
    ...
    public IRubyObject runInterpreter(Node scriptNode) {
        ...
        try {
            return ASTInterpreter.__INTERPRET_ROOT__(this, context, scriptNode, getTopSelf());
        } catch (JumpException.ReturnJump rj) {
            return (IRubyObject) rj.getValue();
        }
    }
    ...
    */
    ...
    public void loadFile(String scriptName, InputStream in, boolean wrap) {
        ...
        try {
            ...
            ASTInterpreter.__INTERPRET_LOAD__(this, context, node, self);
        } catch (JumpException.ReturnJump rj) {
            return;
        } finally {
