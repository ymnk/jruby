...
public class ReWriterContext {
	...
	private final Indentor indentor;
	...
	public ReWriterContext(PrintWriter output, Indentor indentor, String source) {
		super();
		this.output = output;
	...
	public void depositHereDocument(String hereDocument) {
		this.hereDocument = new HereDocument(hereDocument);
	}
