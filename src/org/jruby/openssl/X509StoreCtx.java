...
public class X509StoreCtx extends RubyObject {
    ...
    public IRubyObject chain() throws Exception {
        ...
        for(Iterator iter = chain.iterator();iter.hasNext();) {
            ...
            ary.add(cX509Cert.callMethod("new",getRuntime().newString(new String(x509.getEncoded(),"ISO8859_1"))));
        }
    ...
    public IRubyObject error_string() {
        ...
        return getRuntime().newString(org.jruby.openssl.x509store.X509.verify_cert_error_string(err));
    }
