...
import org.jruby.openssl.x509store.Function2;
...
public class X509Store extends RubyObject {
    ...
    public IRubyObject verify(IRubyObject[] args) throws Exception {
        ...
        X509StoreCtx ctx = (X509StoreCtx)cStoreContext.callMethod("new",new IRubyObject[]{this,cert,chain});
