...
public class RubyKernel {
    ...
    @JRubyMethod(name = {"raise", "fail"}, optional = 3, frame = true, module = true, visibility = PRIVATE, omit = true)
    ...
    @JRubyMethod(name = "caller", optional = 1, frame = true, module = true, visibility = PRIVATE, omit = true)
