...
public class RubyUnboundMethod extends RubyMethod {
    protected RubyUnboundMethod(Ruby runtime) {
        super(runtime, runtime.fastGetClass("UnboundMethod"));
    }
    ...
    public static RubyClass defineUnboundMethodClass(Ruby runtime) {
        ...
        RubyClass newClass = 
        	runtime.defineClass("UnboundMethod", runtime.fastGetClass("Method"), ObjectAllocator.NOT_ALLOCATABLE_ALLOCATOR);
