...
public class SingletonClass extends RubyClass {

    private IRubyObject attachedObject;
    ...
    public IRubyObject getAttachedObject() {
        ...
        // TODO: as far as I can tell, there is no compelling reason to
        // keep this in a (Ruby) instance variable. Guessing that MRI does so to
        // prevent garbage collection, which is not an issue here... -BD
        
        //return getInstanceVariable("__attached__");
        return attachedObject;
    }
    
    public void setAttachedObject(IRubyObject attachedObject) {
        // TODO: as far as I can tell, there is no compelling reason to
        // keep this in a (Ruby) instance variable. Guessing that MRI does so to
        // prevent garbage collection, which is not an issue here... -BD
        
        //setInstanceVariable("__attached__", attachedObject);
