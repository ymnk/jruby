...
public class RubyStruct extends RubyObject {
    ...
    private RubyClass classOf() {
        return getMetaClass() instanceof SingletonClass ? getMetaClass().getSuperClass() : getMetaClass();
    }
    ...
    private IRubyObject setByName(String name, IRubyObject value) {
        RubyArray member = (RubyArray) getAttribute(classOf(), "__member__");
    ...
    public static RubyClass newInstance(IRubyObject recv, IRubyObject[] args, Block block) {
        ...
        newStruct.fastSetAttribute("__size__", member.length());
        newStruct.fastSetAttribute("__member__", member);
    ...
    public static RubyStruct newStruct(IRubyObject recv, IRubyObject[] args, Block block) {
        ...
        int size = RubyNumeric.fix2int(getAttribute((RubyClass) recv, "__size__"));
    ...
    public IRubyObject initialize(IRubyObject[] args, Block unusedBlock) {
        ...
        int size = RubyNumeric.fix2int(getAttribute(getMetaClass(), "__size__"));
    ...
    public static RubyArray members(IRubyObject recv, Block block) {
        RubyArray member = (RubyArray) getAttribute((RubyClass) recv, "__member__");
    ...
    public static void marshalTo(RubyStruct struct, MarshalStream output) throws java.io.IOException {
        ...
        List members = ((RubyArray) getAttribute(struct.classOf(), "__member__")).getList();
